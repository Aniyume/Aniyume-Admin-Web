...
export default function RatingsPage() {
  ...
  return <section className="page"><PageHeader kicker="rating integrity" title="Ratings" description="Модерация оценок: фильтры по anime/user/value, suspicious extremes и удаление накрученных оценок с пересчётом рейтинга." />
